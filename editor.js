...
async function clicker(number, unfillOk){
...
function CorrectTime(calendar, buffer){
    for (let [key, i] of Object.entries(calendar)){
        ...
        // let monthlength = monthDays.getLength((i.end.getMonth()-1+13)%13, i.end.getYear());
    //     if (i.start.getMinutes()<buffer){
    //         if (i.start.getHours()<1){
    //             if (i.start.getDate()<1){
    ...
    //     monthlength = monthDays.getLength(i.end.getMonth(), i.end.getYear());
    //     if (i.end.getMinutes()>(60-buffer)){

    //         if (i.end.getHours()>23){
    //             if (i.end.getDate()>monthlength){
    ...
    //             }
    //             i.end.setDate((i.end.getDate() + 1%monthlength));
    //         }
...
},{"ical":4}],3:[function(require,module,exports){
...
},{"./ical":3,"./node-ical":5}],5:[function(require,module,exports){
...
},{"./ical":3,"fs":1,"rrule":7}],6:[function(require,module,exports){
'use strict';
 ...
 * Copyright (c) 2012 - Tomi Pievil├ñinen <tomi.pievilainen@iki.fi>
 * https://github.com/jakubroztocil/rrule/blob/master/LICENCE
 *
 */
